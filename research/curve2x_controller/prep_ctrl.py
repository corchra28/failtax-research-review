...
files=[f for f in ("controller_lib.py","controller.py","promote.py","tests_controller.py","prep_ctrl.py","freeze_forward.py","publish_ctrl.sh","controller_spec.json","forward_spec.json","README.md","champion.json","test_results.json","evaluation_report_public.json",".gitignore") if os.path.exists(os.path.join(HERE,f))]
